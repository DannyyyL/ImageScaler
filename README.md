...
Notes
- Written in Java (Swing). Main class: Gui (accepts one filename argument).
- Demo GIF: ./demo.gif (replace or add your own).

Author: Dan Lichtin (@DannyyyL)  
License: add a LICENSE file to the repository if desired.
